...
|-------|--------|----------|
| 1-Discovery | {status} | {completed}/{total} |
| 2-Legal | {status} | {completed}/{total} |
| 3-Financial | {status} | {completed}/{total} |
| 4-Materials | {status} | {completed}/{total} |
| 5-Execution | {status} | {completed}/{total} |
...
**To resume:** Re-invoke `/bmad-agent-ios-master` and select `[ORCH]`. I'll pick up right where we left off.
...
**To resume:** Start a new session and run `/bmad-agent-ios-master`, then select `[ORCH]`. I'll detect the saved state and offer to resume from **{next_workflow_name}** in Phase {phase}.
