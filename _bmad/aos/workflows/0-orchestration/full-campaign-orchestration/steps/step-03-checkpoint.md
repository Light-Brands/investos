...
|-------|--------|----------|
| 1-Strategy Foundation | {status} | {completed}/{total} |
| 2-Content Production | {status} | {completed}/{total} |
| 3-Review & Compliance | {status} | {completed}/{total} |
| 4-Distribution & Campaign | {status} | {completed}/{total} |
| 5-Crisis & Ongoing | {status} | {completed}/{total} |
...
**To resume:** Re-invoke `/bmad-agent-aos-master` and select `[ORCH]`. I'll pick up right where we left off.
...
**To resume:** Start a new session and run `/bmad-agent-aos-master`, then select `[ORCH]`. I'll detect the saved state and offer to resume from **{next_workflow_name}** in Phase {phase}.
