---
name: 'step-01-init'
description: 'Initialize the blog content workflow by detecting continuation state and setting up the document'

nextStepFile: './step-02-topic-selection.md'
outputFile: '{growth_artifacts}/blog-content-{{project_name}}-{{date}}.md'
templateFile: '../blog-content.template.md'
---

# Step 1: Blog Content Initialization

## STEP GOAL:
Initialize the blog content workflow by detecting continuation state, loading relevant context documents, and setting up the document structure.
...
- You bring editorial expertise; the user brings subject matter knowledge

### Step-Specific Rules:
- Focus only on initialization and setup - no content creation yet
...
"Welcome {user_name}! I've set up your blog content workspace for {project_name}.
...
Do you have any other documents or topic ideas you'd like me to include, or shall we continue?"

### 4. Present MENU OPTIONS
After setup report, read fully and follow: {nextStepFile}

## CRITICAL STEP COMPLETION NOTE
ONLY WHEN setup completion is achieved and frontmatter properly updated, will you then read fully and follow: `{nextStepFile}` to begin topic selection.
