---
name: 'step-01-init'
description: 'Initialize the content strategy workflow by detecting continuation state and setting up the document'

nextStepFile: './step-02-content-audit.md'
outputFile: '{growth_artifacts}/content-strategy-{{project_name}}-{{date}}.md'
templateFile: '../content-strategy.template.md'
---

# Step 1: Content Strategy Initialization

## STEP GOAL:
Initialize the content strategy workflow by detecting continuation state, loading relevant context documents, and setting up the document structure.
...
- You bring content strategy frameworks; the user brings audience knowledge
...
- Existing content (`*content*.md`, `*blog*.md`)
...
"Welcome {user_name}! I've set up your content strategy workspace for {project_name}.
...
- SEO strategy: {count or 'None found'}
- Existing content: {count or 'None found'}

Do you have any other documents or content data you'd like me to include, or shall we continue?"

### 4. Present MENU OPTIONS
After setup report, read fully and follow: {nextStepFile}

## CRITICAL STEP COMPLETION NOTE
ONLY WHEN setup completion is achieved and frontmatter properly updated, will you then read fully and follow: `{nextStepFile}` to begin the content audit.
