...
Load the project config to restore growth context (product type, target market, channels, budget, etc.)
...
- Project config: {product_type}, {target_market}, {monthly_budget}
