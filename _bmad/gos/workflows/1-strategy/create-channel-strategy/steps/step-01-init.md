---
name: 'step-01-init'
description: 'Initialize the channel strategy workflow by detecting continuation state and setting up the document'

nextStepFile: './step-02-channel-assessment.md'
outputFile: '{growth_artifacts}/channel-strategy-{{project_name}}-{{date}}.md'
templateFile: '../channel-strategy.template.md'
---

# Step 1: Channel Strategy Initialization

## STEP GOAL:
Initialize the channel strategy workflow by detecting continuation state, loading relevant context documents, and setting up the document structure.
...
### Step-Specific Rules:
- Focus only on initialization and setup - no channel analysis yet
...
- Unit economics or growth models (`*economics*.md`, `*model*.md`)
...
"Welcome {user_name}! I've set up your channel strategy workspace for {project_name}.
...
Do you have any other documents or channel data you'd like me to include, or shall we continue?"

### 4. Present MENU OPTIONS
After setup report, read fully and follow: {nextStepFile}

## CRITICAL STEP COMPLETION NOTE
ONLY WHEN setup completion is achieved and frontmatter properly updated, will you then read fully and follow: `{nextStepFile}` to begin channel assessment.
